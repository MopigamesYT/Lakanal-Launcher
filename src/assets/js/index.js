...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Peut-être votre futur collège!", "author": "Mopigames" },
            { "message": "Launcher créé par Mopigames", "author": "Mopigames" },
            { "message": "créé par Mateo PIACENTINO et Maël PREGO!", "author": "Mopigames" }
        ];
